...
VALUES (
    ...
    '$2y$10$/waO8c5q41HngeC2TTvnnuYyz3drDIe6jEMXyh8X6RO/YPoiC.bL.',
    NULL,
    'Demo Administrator',
    'Sincerely Yours, Demo Administrator',
    1,
    'active',
    '644846a924e9f4ca76f04f39b3f9c8ac',
    NULL,
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  ),
  (
    ...
    'cron',
    1,
    'FOF2T4t2@d4mTXP4s.com',
    '$2y$10$gp1mj9ikImkOgg/hoMFvtODEAhMoBhzHji/aF.Ujkqv0h2rzb719e',
    NULL,
    'System Cron Job',
    '',
    1,
...
VALUES (
  ...
  (
    ...
    'This is description',
    'checkbox',
    '{\"first checkbox\":\"0\", \"third checkbox\":\"3\"}',
    1,
    0,
    0,
    NULL,
    '@',
    '.00$',
    '{\"first checkbox\":\"0\", \"second checkbox\": \"1\", \"third checkbox\":\"3\", \"fourth checkbox\":\"4\"}',
    NULL,
    NULL,
    NULL,
    NULL,
  ...
  (
    ...
    '@',
    '.00$',
    '{\"first radio\":\"0\", \"second radio\": \"1\", \"third radio\":\"0\"}',
    NULL,
    NULL,
    NULL,
    NULL,
  ...
  (
    ...
    '@',
    '.00$',
    '{\"first select\":1, \"second select\":\"2\",\"third\": \"3\"}',
    NULL,
    NULL,
    NULL,
    NULL,
...
;
INSERT INTO `forum_topic_message` (
    `id`,
    `forum_topic_id`,
    `client_id`,
    `admin_id`,
...
VALUES (
  ...
  (
    ...
    2,
    NULL,
    'I have some question on how to install BoxBilling?',
    NULL,
    NULL,
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
...
VALUES (
  ...
  (
    ...
    1,
    0,
    'Do you offer recurent payments',
    'Yes we do\n',
    'do-you-offer-recurent-payments',
    'active',
    '2020-01-01 12:00:00',
...
;
INSERT INTO `kb_article_category` (
    `id`,
    `title`,
    `description`,
    `slug`,
...
VALUES (
  ...
  (
    2,
    'How to\'s',
    'Section dedicated for tutorials',
    'how-to',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  );
...
VALUES (
    ...
    1,
    0,
    '{\"single\":\"Transfer {{invoice.total}} {{invoice.currency}}\", \"recurrent\":\"Recurrent payment information\"}'
  ),
  (
    2,
    'BankLink',
...
VALUES (
    1,
    1,
    'BoxBilling is the most affordable Billing Application Ever!',
    'Just in case you weren\'t already aware, BoxBilling is the most affordable client management application ever!\n\nTo learn more about it You can always visit [www.boxbilling.com](http://www.boxbilling.com/)\n',
    'boxbilling-is-affordable-billing-system',
    'active',
    NULL,
    NULL,
    NULL,
  ...
  (
    2,
    1,
    'Check out great features of BoxBilling',
  ...
  (
    3,
    1,
    'BoxBilling is customizable',
    '* You can create your own simple or advanced hooks on BoxBilling events. For example, send notification via sms when new client signs up.\n* Create custom theme for your client interface\n* Create plugin for any cms page\n',
    'boxbilling-is-customizable',
    'active',
    NULL,
    NULL,
  ...
  (
    5,
    1,
    'Unfinished news item',
    'the text is yet to be written\n',
    'to-do',
    'draft',
    NULL,
    NULL,
...
VALUES (
  ...
  (
    ...
    6,
    NULL,
    'Recurrent payment addon',
    NULL,
    'Addon support description',
    'product',
    1,
    'enabled',
    0,
  ...
  (
    ...
    NULL,
    70,
    '{\"prefix\":\"BOX-PRO-\", \"length\":25, \"plugin\":\"Default\"}',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00',
    'license'
  ),
  (
    ...
    NULL,
    70,
    '{\"prefix\":\"BOX-FREE-\", \"length\":25, \"plugin\":\"Default\"}',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00',
    'license'
  ),
  ...
  (
    ...
    NULL,
    2,
    '{\"server_id\":\"1\", \"hosting_plan_id\":\"1\", \"reseller\":0,\"free_domain_periods\":[\"3M\"],\"free_domain\":\"1\",\"free_tlds\":[\".com\"]}',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00',
    'hosting'
  ),
  (
    ...
    NULL,
    3,
    '{\"server_id\":\"1\", \"hosting_plan_id\":\"1\", \"reseller\":1}',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00',
    'hosting'
  ),
  ...
  (
    ...
    'Forum membership',
    'forum-membership',
    'Register for our forum membership',
    'product',
    1,
    'enabled',
    0,
...
VALUES (
    1,
    'Downloadable',
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris magna nisi, aliquet at condimentum ut, congue et orci.\nIn non arcu eget enim ultricies blandit. Nullam eget eros quis nunc tristique malesuada eu sit amet libero.\n',
    NULL,
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  ),
...
;
INSERT INTO `service_hosting_hp` (
    `id`,
    `name`,
    `quota`,
    `bandwidth`,
...
;
INSERT INTO `service_hosting_server` (
    `id`,
    `name`,
    `ip`,
    `hostname`,
...
VALUES (
  ...
  (
    5,
    'company_logo',
    '/bb-themes/boxbilling/assets/images/logo.png',
    0,
    NULL,
    NULL,
    '2020-01-01 12:00:00',
  ...
  (
    21,
    'issue_invoice_days_before_expire',
    '7',
    0,
    NULL,
    NULL,
...
;
INSERT INTO `support_pr` (
    `id`,
    `support_pr_category_id`,
    `title`,
    `content`,
    `created_at`,
    `updated_at`
...
VALUES (
  ...
  (
    ...
    2,
    'It was fixed',
    '\nIt was fixed for your account. If you have any more questions or requests, please let us to know.',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  ),
  (
  ...
  (
    ...
    '\nI have just checked your website and it works fine. Please check it from your end and let us to know if you still experience any problems.',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  ),
  (
    ...
    '\nDo you get any errors and maybe you can copy/paste full error messages?',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  ),
  (
    7,
    3,
    'Domain is not pointing to our server',
    '\nYour domain is not pointing to our server. Please set our nameservers for your domain and give 24 hours until changes will apply worldwide.',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  ),
  (
    8,
    3,
    'What is your domain and username?',
    '\nWhat is your domain name and username?',
    '2020-01-01 12:00:00',
    '2020-01-01 12:00:00'
  );
